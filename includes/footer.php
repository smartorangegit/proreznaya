    ...
    <div class="wrapper flex">
        ...
        <div class="footer__item">
            <dl class="footer_column footer_column__last">
                <dt>Отдел продаж:</dt>
                <dd>Гостомель</dd>
                <dd>ул.Прорезная 1</dd>
                <dd>
                    <a href="#">
                        <span id="istat_1">(063) 220-06-06</span>
                    </a>
                </dd>
            </dl>
...
<footer class="footer">
    <div class="wrapper flex">
        <div class="footer_left flex">
            <span>© Все права защищены. На Прорезной</span>
        </div>
        <div class="footer_right">
            <a href="https://smarto.agency/"  rel="nofollow" target="_blank">
                <img class="smart_logo"  src="/img/svg/smart-orange.svg" alt="Smart Orange" >
            </a>
        </div>
    </div>
</footer>
